...
/* harmony import */ var _circle_circle_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./circle/circle.model */ "./src/app/circle/circle.model.ts");
/* harmony import */ var _rect_rect_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rect/rect.model */ "./src/app/rect/rect.model.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _shared_chain_comparer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/chain-comparer */ "./src/app/shared/chain-comparer.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _circle_circle_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./circle/circle.component */ "./src/app/circle/circle.component.ts");
/* harmony import */ var _rect_rect_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./rect/rect.component */ "./src/app/rect/rect.component.ts");
...
function AppComponent__svg_g_2__svg_g_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "g", 5);
} if (rf & 2) {
    const shape_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("model", shape_r1);
} }
function AppComponent__svg_g_2__svg_g_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
...
function AppComponent__svg_g_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
...
class AppComponent {
    constructor() {
        this.shapes = [
            new _circle_circle_model__WEBPACK_IMPORTED_MODULE_1__["Circle"]({ x: 50, y: 50 }),
            new _circle_circle_model__WEBPACK_IMPORTED_MODULE_1__["Circle"]({ x: 100, y: 150 }),
            new _circle_circle_model__WEBPACK_IMPORTED_MODULE_1__["Circle"]({ x: 150, y: 50 }),
            new _circle_circle_model__WEBPACK_IMPORTED_MODULE_1__["Circle"]({ x: 200, y: 200 }),
            new _rect_rect_model__WEBPACK_IMPORTED_MODULE_2__["Rect"]({ x: 250, y: 50 }),
            new _rect_rect_model__WEBPACK_IMPORTED_MODULE_2__["Rect"]({ x: 300, y: 160 }),
            new _rect_rect_model__WEBPACK_IMPORTED_MODULE_2__["Rect"]({ x: 360, y: 50 }),
            new _rect_rect_model__WEBPACK_IMPORTED_MODULE_2__["Rect"]({ x: 450, y: 200 }),
        ];
        this.shapes.forEach(s => {
            s.isHovered.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])()).subscribe(() => this.updateOrder());
            s.isDragged.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])()).subscribe(() => this.updateOrder());
        });
    }
    updateOrder() {
        if (this.shapes.find(s => s.isDragged.value))
            return;
        this.shapes = this.shapes.sort((a, b) => new _shared_chain_comparer__WEBPACK_IMPORTED_MODULE_4__["ChainComparer"](a, b)
    ...
    onmove(e) {
        var _a;
        (_a = this.shapes.find(s => s.isDragged.value)) === null || _a === void 0 ? void 0 : _a.mouseMove.next({ x: e.x, y: e.y });
    }
    onup(e) {
        var _a;
        (_a = this.shapes.find(s => s.isDragged.value)) === null || _a === void 0 ? void 0 : _a.isDragged.next(false);
    }
}
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(); };
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], hostBindings: function AppComponent_HostBindings(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mousemove", function AppComponent_mousemove_HostBindingHandler($event) { return ctx.onmove($event); })("mouseleave", function AppComponent_mouseleave_HostBindingHandler($event) { return ctx.onup($event); })("mouseup", function AppComponent_mouseup_HostBindingHandler($event) { return ctx.onup($event); });
    } }, decls: 3, vars: 1, consts: [[1, "root"], [2, "width", "100%", "height", "100%"], [4, "ngFor", "ngForOf"], ["app-circle", "", 3, "model", 4, "ngIf"], ["app-rect", "", 3, "model", 4, "ngIf"], ["app-circle", "", 3, "model"], ["app-rect", "", 3, "model"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _rect_rect_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./rect/rect.component */ "./src/app/rect/rect.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        ...
        _rect_rect_component__WEBPACK_IMPORTED_MODULE_5__["RectComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"],
        _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _circle_circle_component__WEBPACK_IMPORTED_MODULE_4__["CircleComponent"],
                    _rect_rect_component__WEBPACK_IMPORTED_MODULE_5__["RectComponent"],
                ],
                imports: [
                    _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"],
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _shared_shape_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/shape.component */ "./src/app/shared/shape.component.ts");



const _c0 = ["app-circle", ""];
class CircleComponent extends _shared_shape_component__WEBPACK_IMPORTED_MODULE_1__["ShapeComponent"] {
}
CircleComponent.ɵfac = function CircleComponent_Factory(t) { return ɵCircleComponent_BaseFactory(t || CircleComponent); };
CircleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CircleComponent, selectors: [["", "app-circle", ""]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], attrs: _c0, decls: 6, vars: 26, consts: [["r", "25"], ["width", "100", "height", "100", 1, "overlay", 3, "mouseover", "mouseout", "mousedown", "mouseup"]], template: function CircleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "g");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mouseover", function CircleComponent_Template__svg_rect_mouseover_5_listener() { return ctx.model.isHovered.next(true); })("mouseout", function CircleComponent_Template__svg_rect_mouseout_5_listener() { return ctx.model.isHovered.next(false); })("mousedown", function CircleComponent_Template__svg_rect_mousedown_5_listener() { return ctx.model.isDragged.next(true); })("mousedown", function CircleComponent_Template__svg_rect_mousedown_5_listener($event) { return ctx.lastMousePosition = { x: $event.x, y: $event.y }; })("mouseup", function CircleComponent_Template__svg_rect_mouseup_5_listener() { return ctx.model.isDragged.next(false); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
const ɵCircleComponent_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](CircleComponent);
...
/* harmony import */ var _shared_shape_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../shared/shape.model */ "./src/app/shared/shape.model.ts");

class Circle extends _shared_shape_model__WEBPACK_IMPORTED_MODULE_0__["Shape"] {
...
const _c0 = ["app-rect", ""];
class RectComponent extends _shared_shape_component__WEBPACK_IMPORTED_MODULE_1__["ShapeComponent"] {
}
RectComponent.ɵfac = function RectComponent_Factory(t) { return ɵRectComponent_BaseFactory(t || RectComponent); };
RectComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RectComponent, selectors: [["", "app-rect", ""]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], attrs: _c0, decls: 6, vars: 26, consts: [["width", "45", "height", "45"], ["width", "100", "height", "100", 1, "overlay", 3, "mouseover", "mouseout", "mousedown", "mouseup"]], template: function RectComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "g");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "rect", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mouseover", function RectComponent_Template__svg_rect_mouseover_5_listener() { return ctx.model.isHovered.next(true); })("mouseout", function RectComponent_Template__svg_rect_mouseout_5_listener() { return ctx.model.isHovered.next(false); })("mousedown", function RectComponent_Template__svg_rect_mousedown_5_listener() { return ctx.model.isDragged.next(true); })("mousedown", function RectComponent_Template__svg_rect_mousedown_5_listener($event) { return ctx.lastMousePosition = { x: $event.x, y: $event.y }; })("mouseup", function RectComponent_Template__svg_rect_mouseup_5_listener() { return ctx.model.isDragged.next(false); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
const ɵRectComponent_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](RectComponent);
...
class Rect extends _shared_shape_model__WEBPACK_IMPORTED_MODULE_0__["Shape"] {
    constructor(position) {
        super(position);
        this.type = "rect";
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChainComparer", function() { return ChainComparer; });
class ChainComparer {
    constructor(a, b) {
        this.a = a;
        this.b = b;
    ...
    compareBy(getTarget) {
        let result = new ChainComparer(this.a, this.b);
    ...
    evaluate() {
        var _a;
        const previous = (_a = this.previous) === null || _a === void 0 ? void 0 : _a.evaluate();
        if (!!previous)
            return previous;
        if (!!this.getTarget) {
...
ShapeComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({ type: ShapeComponent, inputs: { model: "model" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]] });
...
class Shape {
    constructor(position) {
        ...
        this.mouseMove = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"]({ x: 0, y: 0 });
...
module.exports = __webpack_require__(/*! /home/runner/work/AngularSvgExample/AngularSvgExample/src/main.ts */"./src/main.ts");
